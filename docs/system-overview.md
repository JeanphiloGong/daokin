...
The loop is governed by the acceptance criteria in [roadmap/mvp.md](roadmap/mvp.md).
...
- MVP verification evidence should be recorded in the owning issue, PR, release note, or verification report while the canonical criteria stay in [roadmap/mvp.md](roadmap/mvp.md).
